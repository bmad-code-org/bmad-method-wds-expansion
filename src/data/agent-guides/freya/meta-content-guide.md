...
- **SEO Content Instructions:** `../../workflows/wds-ux-design/templates/instructions/seo-content.instructions.md` — Page-level SEO checklist during specification
...
- **Page Specification Template:** `../../workflows/wds-ux-design/templates/page-specification.template.md`
