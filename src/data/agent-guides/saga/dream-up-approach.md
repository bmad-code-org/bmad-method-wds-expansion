...
**Load these WDS learning materials:**
```
src/workflows/wds-scenarios/data/quality-checklist.md
src/workflows/wds-scenarios/data/scenario-outline-template.md
src/workflows/wds-scenarios/data/validation-standards.md
```
