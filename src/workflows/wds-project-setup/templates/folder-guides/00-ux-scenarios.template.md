...
**Workflow:** `_bmad/wds/workflows/wds-scenarios/workflow.md`
**Agent trigger:** `SC` (Saga)

### Page Specifications (Freya)
**Workflow:** `_bmad/wds/workflows/wds-ux-design/workflow.md`
**Agent trigger:** `UX` (Freya)
**Page template:** `_bmad/wds/workflows/wds-ux-design/templates/page-specification.template.md`
**Scenario template:** `_bmad/wds/workflows/wds-ux-design/templates/scenario-overview.template.md`
**Quality guide:** `_bmad/wds/data/agent-guides/freya/specification-quality.md`
**Object types:** `_bmad/wds/workflows/wds-ux-design/object-types/`

### Specification Audit (Freya)
**Workflow:** `_bmad/wds/workflows/wds-ux-design/specification-audit-workflow.md`
