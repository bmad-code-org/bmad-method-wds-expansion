...
**Workflow:** `_bmad/wds/workflows/wds-design-system/workflow.md`
**Agent trigger:** `DS` (Freya)
**Router:** `_bmad/wds/workflows/wds-design-system/design-system-router.md`
**Templates:** `_bmad/wds/workflows/wds-design-system/templates/`
