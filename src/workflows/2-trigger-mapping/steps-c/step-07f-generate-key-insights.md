...
**Complete Template:** See [key-insights-structure.md](../data/key-insights-structure.md)

Generate `05-Key-Insights.md` with these 9 sections:
...
<action>Load and execute: step-07g-quality-check.md</action>
