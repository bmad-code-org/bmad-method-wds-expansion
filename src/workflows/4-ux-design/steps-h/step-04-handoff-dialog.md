...
- ✅ Completed step 03 (Test Scenario created)
...
**See:** [data/handoff-dialog-scripts.md](../data/handoff-dialog-scripts.md) for detailed conversation scripts
...
After the dialog, create handoff log using template in data file.
...
```
[C] Continue to steps-h/step-05-hand-off.md
```
