...
- ✅ Completed step-02-execute (all tests executed)
...
**See:** [data/issue-templates.md](data/issue-templates.md) for complete issue template
...
```
[C] Continue to step-04-report.md
```
