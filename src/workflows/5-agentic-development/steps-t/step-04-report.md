...
- ✅ Completed step-03-document-issues (all issues created)
...
**See:** [data/issue-templates.md](data/issue-templates.md) for complete test report template
...
```
[C] Continue to step-05-iterate.md
```
